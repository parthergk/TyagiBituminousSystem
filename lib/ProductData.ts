...
export const products: Product[] = [
  {
    ...
    description:
      "TBS PMB Emulsion is specially designed water-based emulsion with low viscosity and fast setting time that makes it an ideal product for micro surfacing. It is chocolate brown in color and is free flowing liquid at ambient temperature. TBS PMB Emulsion is manufactured strictly as per IS 8887:2018",
  ...
  },
  {
    ...
    shortName: "RS-1",
    description:
      "TBS Emulsion RS 1 is specially designed water-based emulsion with low viscosity and fast setting time that makes it an ideal product for spray applications. It is chocolate brown in color and is free flowing liquid at ambient temperature. TBS Emulsion RS 1 is manufactured strictly as per IS 8887:2017",
  ...
  },
  {
    ...
    shortName: "MS",
    description:
      "TBS Emulsion MS is specially designed water based Bitumen Emulsion with moderate viscosity and setting time. The medium range of setting time makes it an ideal product for premixing applications. It is chocolate brown in color and free flowing liquid at ambient temperature. TBS Emulsion MS is manufactured strictly as per IS 8887:2017.",
  ...
  },
  {
    ...
    shortName: "Cold Mix",
    description:
      "TBS Cold Mix Emulsion is designed for Cold Mix Technology by PMGSY/PWD to be used in Premix Carpet/Bituminous macadam & Seal coat. These emulsions are tailored made & paver made as per quality of aggregates and local site conditions & machinery availability.",
    ...
    availability: ["Bulk", "HDPE Drums 200 kg"],
    additionalInfo:
      "The Cold Mix Emulsion can be used for Emulsion Treated Aggregate (ETA) & Cold Mix Bituminous Macadam (CMBM) using paver grade TBS Cold mix Emulsion. It can be applied using Hot Mix Plant or through Manual Execution.",
  },
];
