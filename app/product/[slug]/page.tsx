...
const ProductDetailPage = async ({
  ...
  return (
    <main>
      <section className=" h-16 bg-primary"></section>
      <div className=" pt-12 md:pt-16 px-4 md:px-6 lg:px-8">
        <div className=" rounded-lg  overflow-hidden">
          ...
          <div className="bg-primary text-white p-6 md:p-8">
            ...
            <p className="mt-2 text-lg opacity-90">{product.description}</p>
          </div>
          ...
          <div className="py-6 md:py-8">
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="py-3 px-4 text-left border border-gray-200 font-semibold">
                        Property
                      </th>
                      <th className="py-3 px-4 text-left border border-gray-200 font-semibold">
                        Value
            ...
            <section className="mt-16 pt-6 border-t border-gray-200">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="mb-4">
                  The foremost objective of our entity is to provide quality.
                  Every grade of TBS Emulsion is duely Tested and certified in
                  NABL laboratories.
                </p>
                <h3 className="font-semibold mb-2">
                  We assure our clients to provide quality in terms of material
                  as well as in the whole process of undertaking a project which
                  includes:
                </h3>
                <ul className="list-disc pl-5 space-y-2">
